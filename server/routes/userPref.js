...
router.post('/', async(req, res) => {
    try{
        ...
        const userPref = await prisma.userPreference.upsert({
            ...
            update: { name, gender, educationStatus, explanationStyle: explanation, comfortLanguage: language},
            create: {name, gender, educationStatus, explanationStyle: explanation, comfortLanguage: language, user: {connect: {clerkId: user.clerkId}}}
        })
