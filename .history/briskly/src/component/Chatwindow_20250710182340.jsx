...
const handleSendFIle = async () => {
    ...
    formData.append('fileName', selectedFile.name); // add file name separately
    formData.append('customName', 'MyCustomName');  // add custom name if needed
    ...
    try{
      ...
      console.err("Error occured while sneding file error:"+err);
    }
}
