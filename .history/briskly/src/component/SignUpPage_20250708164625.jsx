  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black text-white px-4">
      <div className="w-full max-w-md bg-[#121212] p-8 rounded-2xl shadow-lg">
        <h2 className="text-2xl bg-[#121212] font-bold mb-1">Welcome to IntellectUP</h2>
        <br />

        <form onSubmit={handleSignUp} className="space-y-4">
          <div>
            <label className="block text-sm bg-[#121212] font-medium mb-1">
            ...
            <input
              ...
              className="w-full  px-4 py-2 bg-[#121212] text-white rounded-lg border border-gray-600 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
              required
            />
          </div>

          <div>
            <label className="block bg-[#121212] text-sm font-medium mb-1">
