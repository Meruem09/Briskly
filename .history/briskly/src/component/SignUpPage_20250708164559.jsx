        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#121212] px-4 py-2 bg-gray-950 text-white rounded-lg border border-gray-600 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
              required
            />
          </div>
